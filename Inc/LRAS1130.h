...
struct AS1130Picture12x11 {
	uint8_t picture[12][11]
};
...
///
void setOnOffFrame(uint8_t frameIndex, const AS1130Picture12x11 &picture, uint8_t pwmSetIndex); // default pwmSetIndex = 0
