 ...
 * USB_HID_KEY_ERR_OVF in all slots to indicate this condition.
 */
...
#define USB_HID_KEY_OPEN 0x74 // Keyboard Execute
#define USB_HID_KEY_HELP 0x75 // Keyboard Help
#define USB_HID_KEY_PROPS 0x76 // Keyboard Menu
#define USB_HID_KEY_FRONT 0x77 // Keyboard Select
#define USB_HID_KEY_STOP 0x78 // Keyboard Stop
#define USB_HID_KEY_AGAIN 0x79 // Keyboard Again
#define USB_HID_KEY_UNDO 0x7a // Keyboard Undo
#define USB_HID_KEY_CUT 0x7b // Keyboard Cut
#define USB_HID_KEY_COPY 0x7c // Keyboard Copy
#define USB_HID_KEY_PASTE 0x7d // Keyboard Paste
#define USB_HID_KEY_FIND 0x7e // Keyboard Find
#define USB_HID_KEY_MUTE 0x7f // Keyboard Mute
#define USB_HID_KEY_VOLUMEUP 0x80 // Keyboard Volume Up
#define USB_HID_KEY_VOLUMEDOWN 0x81 // Keyboard Volume Down
// 0x82  Keyboard Locking Caps Lock
// 0x83  Keyboard Locking Num Lock
// 0x84  Keyboard Locking Scroll Lock
#define USB_HID_KEY_KPCOMMA 0x85 // Keypad Comma
// 0x86  Keypad Equal Sign
#define USB_HID_KEY_RO 0x87 // Keyboard International1
#define USB_HID_KEY_KATAKANAHIRAGANA 0x88 // Keyboard International2
#define USB_HID_KEY_YEN 0x89 // Keyboard International3
#define USB_HID_KEY_HENKAN 0x8a // Keyboard International4
#define USB_HID_KEY_MUHENKAN 0x8b // Keyboard International5
#define USB_HID_KEY_KPJPCOMMA 0x8c // Keyboard International6
// 0x8d  Keyboard International7
// 0x8e  Keyboard International8
// 0x8f  Keyboard International9
#define USB_HID_KEY_HANGEUL 0x90 // Keyboard LANG1
#define USB_HID_KEY_HANJA 0x91 // Keyboard LANG2
#define USB_HID_KEY_KATAKANA 0x92 // Keyboard LANG3
#define USB_HID_KEY_HIRAGANA 0x93 // Keyboard LANG4
#define USB_HID_KEY_ZENKAKUHANKAKU 0x94 // Keyboard LANG5
// 0x95  Keyboard LANG6
// 0x96  Keyboard LANG7
// 0x97  Keyboard LANG8
// 0x98  Keyboard LANG9
...
#define USB_HID_KEY_KPLEFTPAREN 0xb6 // Keypad (
#define USB_HID_KEY_KPRIGHTPAREN 0xb7 // Keypad )
// 0xb8  Keypad {
// 0xb9  Keypad }
// 0xba  Keypad Tab
...
#define USB_HID_KEY_LEFTCTRL 0xe0 // Keyboard Left Control
#define USB_HID_KEY_LEFTSHIFT 0xe1 // Keyboard Left Shift
#define USB_HID_KEY_LEFTALT 0xe2 // Keyboard Left Alt
#define USB_HID_KEY_LEFTMETA 0xe3 // Keyboard Left GUI
#define USB_HID_KEY_RIGHTCTRL 0xe4 // Keyboard Right Control
#define USB_HID_KEY_RIGHTSHIFT 0xe5 // Keyboard Right Shift
#define USB_HID_KEY_RIGHTALT 0xe6 // Keyboard Right Alt
#define USB_HID_KEY_RIGHTMETA 0xe7 // Keyboard Right GUI
