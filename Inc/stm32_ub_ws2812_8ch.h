...
//--------------------------------------------------------------
// benutzer Timer fuer die Daten-Signale
//--------------------------------------------------------------
// ROW 1
#define  WS2812_CH1_TIM_CLOCK     RCC_APB1Periph_TIM4
#define  WS2812_CH1_TIM           TIM4
#define  WS2812_CH1_TIM_AF        GPIO_AF_TIM4
#define  WS2812_CH1_TIM_CH        3
#define  WS2812_CH1_TIM_CCR_REG1  TIM4->CCR3
#define  WS2812_CH1_TIM_DMA_TRG1  TIM_DMA_CC3
...
#define  WS2812_CH1_PIN      GPIO_Pin_8
#define  WS2812_CH1_SOURCE   GPIO_PinSource8

#define  WS2812_CH2_CLOCK    RCC_AHB1Periph_GPIOC
#define  WS2812_CH2_PORT     GPIOC
#define  WS2812_CH2_PIN      GPIO_Pin_9
#define  WS2812_CH2_SOURCE   GPIO_PinSource9

#define  WS2812_CH3_CLOCK    RCC_AHB1Periph_GPIOB
#define  WS2812_CH3_PORT     GPIOB
#define  WS2812_CH3_PIN      GPIO_Pin_4
#define  WS2812_CH3_SOURCE   GPIO_PinSource4

#define  WS2812_CH4_CLOCK    RCC_AHB1Periph_GPIOB
#define  WS2812_CH4_PORT     GPIOB
#define  WS2812_CH4_PIN      GPIO_Pin_5
#define  WS2812_CH4_SOURCE   GPIO_PinSource5
...
#define  WS2812_CH5_PIN      GPIO_Pin_13
#define  WS2812_CH5_SOURCE   GPIO_PinSource13

#define  WS2812_CH6_CLOCK    RCC_AHB1Periph_GPIOB
#define  WS2812_CH6_PORT     GPIOB
#define  WS2812_CH6_PIN      GPIO_Pin_0
#define  WS2812_CH6_SOURCE   GPIO_PinSource0
...
#define  WS2812_DMA_CH2_IRQ_FLAG  DMA_IT_TCIF2
...
#define  WS2812_DMA_CH4_IRQn      DMA1_Stream5_IRQn
